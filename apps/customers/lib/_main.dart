...
import 'package:lite/shared/shared.dart' show notificationsPlugin;
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _showNotificationWithNoSound() async {
    ...
    const NotificationDetails platformChannelSpecifics = NotificationDetails(
        ...
        iOS: iOSPlatformChannelSpecifics,
        macOS: macOSPlatformChannelSpecifics);
    await notificationsPlugin.show(0, '<b>silent</b> title',
  ...
  Future<void> _showTimeoutNotification() async {
    ...
    const NotificationDetails platformChannelSpecifics =
        NotificationDetails(android: androidPlatformChannelSpecifics);
    await notificationsPlugin.show(0, 'timeout notification',
  ...
  Future<void> _showGroupedNotifications() async {
    ...
    await notificationsPlugin.show(1, 'Alex Faarborg',
  ...
  Future<void> _showOngoingNotification() async {
    ...
    const NotificationDetails platformChannelSpecifics =
        NotificationDetails(android: androidPlatformChannelSpecifics);
    await notificationsPlugin.show(0, 'ongoing notification title',
  ...
  Future<void> _showPublicNotification() async {
    ...
    const NotificationDetails platformChannelSpecifics =
        NotificationDetails(android: androidPlatformChannelSpecifics);
    await notificationsPlugin.show(0, 'public notification title',
