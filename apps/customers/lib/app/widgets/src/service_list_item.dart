...
class ServiceIssueListView extends StatefulWidget {
  const ServiceIssueListView({
    Key key,
  ...
  @override
  _ServiceIssueListViewState createState() => _ServiceIssueListViewState();
}

class _ServiceIssueListViewState extends State<ServiceIssueListView> {
  @override
  Widget build(BuildContext context) => Container(
        width: SizeConfig.screenWidth,
        height: SizeConfig.screenHeight,
...
class ServiceIssueListTile extends StatefulWidget {
  const ServiceIssueListTile({
    Key key,
    @required this.issue,
    this.onTap,
    this.selected = false,
  ...
  @override
  _ServiceIssueListTileState createState() => _ServiceIssueListTileState();
}

class _ServiceIssueListTileState extends State<ServiceIssueListTile> {
