...
import 'package:handyman/app/pages/photo_preview.dart';
...
import 'package:handyman/app/pages/provider/business_center.dart';
...
@MaterialAutoRouter(
  routes: [
    ...
    AdaptiveRoute(page: PhotoPreviewPage, guards: [AuthGuard]),
    ...
    AdaptiveRoute(page: BusinessCenterPage, guards: [AuthGuard, ProviderGuard]),
  ],
)
class $Router {}
